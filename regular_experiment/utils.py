''' 
Nahuel .- Generate or load data/parameters for the model.
'''
...
def rgan_options_parser():
    ...
    parser.add_argument('--data', help='what kind of data to train with?',
            ...
            choices=['gp_rbf', 'sine', 'mnist', 'load',
                'resampled_eICU', 'eICU_task', 'markov'])
    ...
    parser.add_argument('--normalise', type=bool, default=True, help='normalise the \
    ...
    parser.add_argument('--D_rounds', type=int, default=1, help='number of rounds \
            of discriminator training')
    parser.add_argument('--G_rounds', type=int, default=3, help='number of rounds \
